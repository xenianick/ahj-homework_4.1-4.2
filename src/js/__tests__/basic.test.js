...
test.each([
  ['true for existing card code', '362823914535', true],
  ['false for nonexistent card code', '02374526893', false],
...
test.each([
  ['true for existing card code', '49203420324', true],
  ['false for nonexistent card code', '13474526893', false],
])(('should be %s'), (_, input, expected) => {
...
test.each([
  ['true for existing card code', '2', true],
  ['false for nonexistent card code', '1', false],
])(('should be %s'), (_, input, expected) => {
